...
export default function InfoModal(props) {
    return (
        ...
        <Modal.Body>
          <h4>Lieve allemaal, welkom om de herinneringswebsite van Jacqueline. </h4>
            <p>
                Via deze website willen wij een plek creëren waar Tess meer te weten kan komen over haar moeder. De gene die dat het beste kunnen vertellen zijn de vrienden en familie van Jacqueline. 
            ...
            <p>
                <strong>Belangrijk is dat we een positieve toon willen houden op de website, houdt daar rekening mee!</strong> Denk aan vakanties, feestjes, carnaval, iets deuzigs enz. 
            </p>    
            <p>
                Het uploaden wijst zich vanzelf, maar zal een korte introductie geven. 
            </p>
            ...
            <ul>
                ...
                <li> Kies je tekstkleur en kaartkleur en check of het naar wens is zoals weergegeven in het voorbeeld. (voorbeeld kaart)</li>
